...
contract NFTMarketplace is ERC721URIStorage {
    ...
    function getMyNFTs() public view returns(ListedToken[] memory){
        ...
        // Important to get a count of all the nFTs that belong to the user before we can make an array  of them
    ...
    function executeSale(uint256 tokenId) public payable {
        ...
        require(msg.value == price, "Please submit the asking price for the NFT is order to purchase");
